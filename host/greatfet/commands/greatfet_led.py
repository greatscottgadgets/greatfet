...
def main():
    ...
    parser.add_argument('-t', '--toggle', nargs='*', type=ast.literal_eval, default=[], help="Number of bytes expecting to receive from the I2C Bus")
    parser.add_argument('--on', nargs='*', type=ast.literal_eval, default=[], help="Number of bytes expecting to receive from the I2C Bus")
    parser.add_argument('--off', nargs='*', type=ast.literal_eval, default=[], help="Number of bytes expecting to receive from the I2C Bus")
