...
// Get a handle on the libgreat heap.
extern uint8_t libgreat_heap[CONFIG_LIBGREAT_HEAP_SIZE];

/* Start addresses and the size of the heap */
#define UMM_MALLOC_CFG_HEAP_ADDR  libgreat_heap 
#define UMM_MALLOC_CFG_HEAP_SIZE  sizeof(libgreat_heap)
